 ...
 * 
 * <p>Processing status may be checked by polling Strava. A one-second or longer polling interval is recommended. The mean processing time is currently around 8 seconds. Once processing is complete, Strava will respond to polling requests with the activity’s ID.</p>
 * 
 * <p>Errors can occur during the submission or processing steps and may be due to malformed activity data or duplicate data submission.</p>
 * 
 * <p>Strava supports FIT, TCX and GPX file types as described below. New file types are not on the road map. Developers are encouraged to use one of these types as it will also maximize compatibility with other fitness applications.</p>
 * 
 * <p>All files are required to include a time with each trackpoint or record, as defined by the file format. Information such as lat/lng, elevation, heartrate, etc. is optional. Manual creation of activities without a data file is not currently supported by the API.</p>
 * 
 * <p>If you feel your file is compatible with the standards but is still not uploading to Strava, please verify that it works with other fitness applications before contacting support.</p>
 * 
 * 
 * 
 * @author Dan Shannon
...
public interface UploadServices {
	 ...
	 * 
	 * <p>Posting a file for upload will enqueue it for processing. Initial checks will be done for malformed data and duplicates.</p>
	 * 
	 * <p>URL POST https://www.strava.com/api/v3/uploads</p>
	 * 
	 * @see http://strava.github.io/api/v3/uploads/#post-file
	 * 
	 * @param activityType (Optional) Type of activity being uploaded
	 ...
	 */
	public UploadResponse upload(ActivityType activityType, String name, String description, Boolean _private, Boolean trainer, String dataType, String externalId, File file);
	 ...
	 * 
	 * <p>URL GET https://www.strava.com/api/v3/uploads/:id</p>
	 * 
