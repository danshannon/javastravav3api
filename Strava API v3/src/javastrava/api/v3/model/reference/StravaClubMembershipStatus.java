...
public enum StravaClubMembershipStatus implements StravaReferenceType<String> {
	...
	/**
	 * @see javastrava.api.v3.model.reference.StravaReferenceType#getDescription()
	 */
	@Override
	...
	/**
	 * @see javastrava.api.v3.model.reference.StravaReferenceType#getId()
	 */
	@Override
	public String getId() {
		return this.id;
	...
	/**
	 * @see javastrava.api.v3.model.reference.StravaReferenceType#getValue()
	 */
	@Override
