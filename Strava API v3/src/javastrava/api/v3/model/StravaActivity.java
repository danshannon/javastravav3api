...
public class StravaActivity implements StravaCacheable<Long>, StravaEntity {
	...
	/**
	 * Name of the activity. Defaults to boring things, but athletes with imagination will come up with witty and interesting names
	 * on a regular basis!
	 */
	private String				name;
	/**
	 ...
	 *
	 * <p>
	 * To get the list of activities by all the other people who also took part, see
	...
	/**
	 * Is set to <code>true</code> if the activity was manually entered into Strava, rather than being uploaded as a file from some
	 * GPS device, or your phone
	 * </p>
	 */
	...
	/**
	 * Is set to <code>true</code> if the activity has been flagged as suspicious by another user on Strava, usually because it has
	 * crazy speeds because it was done in a car, not on a bike
	 */
	...
	/**
	 * Maximum speed (in metres per second) achieved during the activity (quite often as a result of GPS inaccuracies). Calculated
	 * by Strava and not recalculated or checked by javastrava.
	 */
	...
	/**
	 * Average power (in watts) for rides only. Strava calculates an estimate for this if power meter data is not provided with the
	 * upload.
	 */
	...
	/**
	 * The token used to construct an embed URL in the form <a href=
	 * "https://www.strava.com/activities/[ACTIVITY_ID]/embed/[embedId]">https://www.strava.com/activities/[ACTIVITY_ID]/embed/[embedId]</a>
	 */
	...
	public String toString() {
		return "StravaActivity [id=" + this.id + ", resourceState=" + this.resourceState + ", externalId=" + this.externalId //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				+ ", athlete=" + this.athlete + ", name=" + this.name + ", description=" + this.description + ", distance=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				+ this.distance + ", movingTime=" + this.movingTime + ", elapsedTime=" + this.elapsedTime + ", totalElevationGain=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				...
				+ ", commute=" + this.commute + ", manual=" + this.manual + ", privateActivity=" + this.privateActivity //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				+ ", flagged=" //$NON-NLS-1$
				+ this.flagged + ", workoutType=" + this.workoutType + ", gearId=" + this.gearId + ", gear=" + this.gear //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				+ ", averageSpeed=" //$NON-NLS-1$
				...
				+ ", averageHeartrate=" + this.averageHeartrate + ", maxHeartrate=" + this.maxHeartrate + ", calories=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				+ this.calories + ", hasKudoed=" + this.hasKudoed + ", segmentEfforts=" + this.segmentEfforts + ", splitsMetric=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				+ this.splitsMetric + ", splitsStandard=" + this.splitsStandard + ", bestEfforts=" + this.bestEfforts //$NON-NLS-1$ //$NON-NLS-2$
				...
				+ this.embedToken + ", deviceName=" + this.deviceName + ", sufferScore=" + this.sufferScore + "]"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
