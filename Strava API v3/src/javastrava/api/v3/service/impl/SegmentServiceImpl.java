...
public class SegmentServiceImpl extends StravaServiceImpl implements SegmentService {
	...
	/**
	 * <p>
	 * Most irritatingly, Strava returns one list of leaderboard entries that is
	 * actually two lists
	 * </p>
	 *
	 * <p>
	 ...
	 *            The paging instruction that was sent to Strava API, so we can
	 *            work out how to split the entries up
	 * @param contextSize
	 *            Number of entries either side of the athlete's to return as
	 *            context
	...
	/**
	 * @see javastrava.api.v3.service.SegmentService#getAllSegmentLeaderboard(java.lang.Integer,
	 *      javastrava.api.v3.model.reference.StravaGender,
	 *      javastrava.api.v3.model.reference.StravaAgeGroup,
	 *      javastrava.api.v3.model.reference.StravaWeightClass,
	...
	public StravaSegmentLeaderboard getAllSegmentLeaderboard(final Integer segmentId, final StravaGender gender,
		...
		while (loop) {
			...
			try {
				currentPage = getSegmentLeaderboard(segmentId, gender, ageGroup, weightClass, following, clubId,
						dateRange, new Paging(Integer.valueOf(page), StravaConfig.MAX_PAGE_SIZE), Integer.valueOf(2));
	...
	/**
	 * @see javastrava.api.v3.service.SegmentService#getSegmentLeaderboard(Integer,
	 *      StravaGender, StravaAgeGroup, StravaWeightClass, Boolean, Integer,
	...
	public StravaSegmentLeaderboard getSegmentLeaderboard(final Integer segmentId, final StravaGender gender,
		...
		// 15
		final Integer context = (contextEntries == null ? Integer.valueOf(2) : Integer.valueOf(Math.max(0,
	...
	/**
	 * @see javastrava.api.v3.service.SegmentService#listAllSegmentEfforts(java.lang.Integer,
	 *      java.lang.Integer, LocalDateTime, LocalDateTime)
	 */
	@Override
	...
	public List<StravaSegment> listAuthenticatedAthleteStarredSegments(final Paging pagingInstruction) {
		final List<StravaSegment> segments = PagingHandler.handlePaging(
				pagingInstruction,
	 ...
	 */
	@Override
	public List<StravaSegmentEffort> listSegmentEfforts(final Integer id, final Integer athleteId,
	...
	/**
	 * @see javastrava.api.v3.service.SegmentService#listSegmentEfforts(Integer,
	 *      Integer, LocalDateTime, LocalDateTime, Paging)
	 */
	@Override
	public List<StravaSegmentEffort> listSegmentEfforts(final Integer id, final Integer athleteId,
		...
		final List<StravaSegmentEffort> efforts = PagingHandler.handlePaging(pagingInstruction, thisPage -> Arrays
				.asList(SegmentServiceImpl.this.api.listSegmentEfforts(id, athleteId, start, end, thisPage.getPage(),
	...
	/**
	 * @see javastrava.api.v3.service.SegmentService#listStarredSegments(Integer,
	 *      Paging)
	 */
	@Override
	public List<StravaSegment> listStarredSegments(final Integer id, final Paging pagingInstruction) {
		final List<StravaSegment> segments = PagingHandler.handlePaging(pagingInstruction,
				thisPage -> Arrays.asList(SegmentServiceImpl.this.api.listStarredSegments(id, thisPage.getPage(),
						thisPage.getPageSize())));
	...
	/**
	 * @see javastrava.api.v3.service.SegmentService#segmentExplore(StravaMapPoint,
	 *      StravaMapPoint, StravaSegmentExplorerActivityType,
	 *      StravaClimbCategory, StravaClimbCategory)
	 */
	@Override
	public StravaSegmentExplorerResponse segmentExplore(final StravaMapPoint southwestCorner,
