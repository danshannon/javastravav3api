...
public interface SegmentAPI {
	 ...
	 */
	@GET("/segments/{id}")
	public void getSegment(@Path("id") final Integer segmentId, final StravaAPICallback<StravaSegment> callback)
			throws NotFoundException;

	/**
	 * @see javastrava.api.v3.service.SegmentService#getSegmentLeaderboard(Integer, StravaGender, StravaAgeGroup, StravaWeightClass,
	 *      Boolean, Integer, StravaLeaderboardDateRange, javastrava.util.Paging, Integer)
	 *
	 * @param segmentId
	 *            Segment identifier
	 * @param gender
	...
	public StravaSegmentLeaderboard getSegmentLeaderboard(@Path("id") final Integer segmentId,
			@Query("gender") final StravaGender gender, @Query("age_group") final StravaAgeGroup ageGroup,
			@Query("weight_class") final StravaWeightClass weightClass, @Query("following") final Boolean following,
			@Query("club_id") final Integer clubId, @Query("date_range") final StravaLeaderboardDateRange dateRange,
	 ...
	 */
	@GET("/segments/{id}/leaderboard")
	public void getSegmentLeaderboard(@Path("id") final Integer segmentId, @Query("gender") final StravaGender gender,
			@Query("age_group") final StravaAgeGroup ageGroup, @Query("weight_class") final StravaWeightClass weightClass,
			@Query("following") final Boolean following, @Query("club_id") final Integer clubId,
			@Query("date_range") final StravaLeaderboardDateRange dateRange, @Query("page") final Integer page,
			@Query("per_page") final Integer perPage, @Query("context_entries") final Integer contextEntries,
			final StravaAPICallback<StravaSegmentLeaderboard> callback) throws NotFoundException, BadRequestException;
	...
	public StravaSegment[] listAuthenticatedAthleteStarredSegments(@Query("page") final Integer page,
	 ...
	 */
	@GET("/segments/starred")
	public void listAuthenticatedAthleteStarredSegments(@Query("page") final Integer page, @Query("per_page") final Integer perPage,
			final StravaAPICallback<StravaSegment[]> callback) throws BadRequestException;

	/**
	 * @see javastrava.api.v3.service.SegmentService#listSegmentEfforts(Integer, Integer, LocalDateTime, LocalDateTime,
	...
	public StravaSegmentEffort[] listSegmentEfforts(@Path("id") final Integer segmentId,
			@Query("athlete_id") final Integer athleteId, @Query("start_date_local") final String start,
			@Query("end_date_local") final String end, @Query("page") final Integer page, @Query("per_page") final Integer perPage)
	 ...
	 */
	@GET("/segments/{id}/all_efforts")
	public void listSegmentEfforts(@Path("id") final Integer segmentId, @Query("athlete_id") final Integer athleteId,
			@Query("start_date_local") final String start, @Query("end_date_local") final String end,
			@Query("page") final Integer page, @Query("per_page") final Integer perPage,
	...
	public StravaSegment[] listStarredSegments(@Path("id") final Integer athleteId, @Query("page") final Integer page,
	 ...
	 */
	@GET("/athletes/{id}/segments/starred")
	public void listStarredSegments(@Path("id") final Integer athleteId, @Query("page") final Integer page,
			@Query("per_page") final Integer perPage, final StravaAPICallback<StravaSegment[]> callback)
			throws NotFoundException, BadRequestException;

	/**
	 * @see javastrava.api.v3.service.SegmentService#segmentExplore(javastrava.api.v3.model.StravaMapPoint,
	 *      javastrava.api.v3.model.StravaMapPoint, StravaSegmentExplorerActivityType, StravaClimbCategory, StravaClimbCategory)
	 *
	 * @param bounds
	...
	public StravaSegmentExplorerResponse segmentExplore(@Query("bounds") final String bounds,
			@Query("activity_type") final StravaSegmentExplorerActivityType activityType,
	 ...
	 */
	@GET("/segments/explore")
	public void segmentExplore(@Query("bounds") final String bounds,
			@Query("activity_type") final StravaSegmentExplorerActivityType activityType,
			@Query("min_cat") final StravaClimbCategory minCategory, @Query("max_cat") final StravaClimbCategory maxCategory,
			final StravaAPICallback<StravaSegmentExplorerResponse> callback);
