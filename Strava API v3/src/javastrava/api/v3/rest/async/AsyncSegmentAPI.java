 ...
 *
 */
public interface AsyncSegmentAPI {
	/**
	...
	public void getSegmentLeaderboard(@Path("id") final Integer segmentId, @Query("gender") final StravaGender gender,
			...
			@Query("per_page") final Integer perPage, @Query("context_entries") final Integer contextEntries, final StravaAPICallback<StravaSegmentLeaderboard> callback) throws NotFoundException, BadRequestException;
	...
	public void listAuthenticatedAthleteStarredSegments(@Query("page") final Integer page, @Query("per_page") final Integer perPage, final StravaAPICallback<StravaSegment[]> callback) throws BadRequestException;
	...
	public void listSegmentEfforts(@Path("id") final Integer segmentId, @Query("athlete_id") final Integer athleteId,
			...
			@Query("per_page") final Integer perPage, final StravaAPICallback<StravaSegmentEffort[]> callback) throws NotFoundException, BadRequestException;
