...
public interface StreamServicesRetrofit {
	...
	/**
	 * @see stravajava.api.v3.service.StreamServices#getActivityStreams(Integer, StravaStreamResolutionType,
	 *      StravaStreamSeriesDownsamplingType, stravajava.api.v3.model.reference.StravaStreamType...)
	 * 
	 * @param id
	...
	/**
	 * @see stravajava.api.v3.service.StreamServices#getEffortStreams(Long, StravaStreamResolutionType,
	 *      StravaStreamSeriesDownsamplingType, stravajava.api.v3.model.reference.StravaStreamType...)
	 * 
	 * @param id
	...
	/**
	 * @see stravajava.api.v3.service.StreamServices#getSegmentStreams(Integer, StravaStreamResolutionType,
	 *      StravaStreamSeriesDownsamplingType, stravajava.api.v3.model.reference.StravaStreamType...)
	 * 
	 * @param id
