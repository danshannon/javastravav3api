...
public class ActivityServicesImpl extends StravaServiceImpl implements ActivityServices {
	...
	return PagingHandler.handlePaging(pagingInstruction, new PagingCallback<StravaActivity>() {
		...
		return Arrays.asList(ActivityServicesImpl.this.restService.listAuthenticatedAthleteActivities(
    ...
    /**
     * @see stravajava.api.v3.service.ActivityServices#listFriendsActivities(java.lang.Integer,
     *      java.lang.Integer)
     */
    @Override
	...
	return PagingHandler.handlePaging(pagingInstruction, new PagingCallback<StravaActivity>() {
	    @Override
	    public List<StravaActivity> getPageOfData(final Paging thisPage) throws NotFoundException {
		return Arrays.asList(ActivityServicesImpl.this.restService.listFriendsActivities(thisPage.getPage(),
	...
	return PagingHandler.handlePaging(pagingInstruction, new PagingCallback<StravaComment>() {
		...
		return Arrays.asList(ActivityServicesImpl.this.restService.listActivityComments(id, markdown,
	...
	return PagingHandler.handlePaging(pagingInstruction, new PagingCallback<StravaAthlete>() {
		...
		return Arrays.asList(ActivityServicesImpl.this.restService.listActivityKudoers(id, thisPage.getPage(),
			thisPage.getPageSize()));
	    }
	});
    ...
    /**
     * @see stravajava.api.v3.service.ActivityServices#listAuthenticatedAthleteActivities(java.util.Calendar,
     *      java.util.Calendar)
     */
    @Override
    public List<StravaActivity> listAuthenticatedAthleteActivities(final Calendar before, final Calendar after) {
	...
	return PagingHandler.handlePaging(pagingInstruction, new PagingCallback<StravaActivity>() {
	    @Override
	    public List<StravaActivity> getPageOfData(final Paging thisPage) throws NotFoundException {
		return Arrays.asList(ActivityServicesImpl.this.restService.listRelatedActivities(id,
			thisPage.getPage(), thisPage.getPageSize()));
	    }
	});
    }
