...
/**
 * <p>{@link StravaGear} related services.</p>
 * 
...
public interface GearServices {
	/**
	 * <p>Retrieve details about a specific item of {@link StravaGear}. The requesting {@link StravaAthlete} must own the {@link StravaGear}. At this time it is not possible to view just anyone's gear type and usage.</p>
	 * 
	 ...
	 * 
	 * @param id The id of the {@link StravaGear} to be retrieved.
