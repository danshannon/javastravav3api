...
public interface StreamServices {
	 ...
	 */
	public List<StravaStream> getActivityStreams(String id, StravaStreamType[] types, StravaStreamResolutionType resolution, StravaStreamSeriesDownsamplingType seriesType);
	 ...
	 * @return Returns an array of unordered stream objects.
	 */
	public List<StravaStream> getEffortStreams(String id, StravaStreamType[] types, StravaStreamResolutionType resolution, StravaStreamSeriesDownsamplingType seriesType);
	 ...
	 * @return Returns an array of unordered stream objects.
	 */
	public List<StravaStream> getSegmentStreams(String id, StravaStreamType[] types, StravaStreamResolutionType resolution, StravaStreamSeriesDownsamplingType seriesType);
