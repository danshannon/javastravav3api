...
public interface TokenServices {
	 ...
	 * 
	 * <p>This will invalidate all access tokens associated with the athlete, application pair used to create the token. The application will be removed from the StravaAthlete Settings page on Strava.</p>
	 * 
